...
gn gen out/Release --args='target_os="ios" target_cpu="arm64" target_environment="device" is_debug=false angle_enable_vulkan=true angle_enable_metal=false angle_enable_gl=false'
