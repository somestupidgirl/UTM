...
sed -i '' 's/FALLBACK_CONFIG_DIRS/"\/etc\/xdg"/g' third_party/vulkan-loader/src/loader/settings.c || true
sed -i '' 's/FALLBACK_DATA_DIRS/"\/usr\/local\/share:\/usr\/share"/g' third_party/vulkan-loader/src/loader/settings.c || true
sed -i '' 's/SYSCONFDIR/"\/etc"/g' third_party/vulkan-loader/src/loader/settings.c || true
sed -i '' 's/FALLBACK_CONFIG_DIRS/"\/etc\/xdg"/g' third_party/vulkan-loader/src/loader/loader.c || true
sed -i '' 's/FALLBACK_DATA_DIRS/"\/usr\/local\/share:\/usr\/share"/g' third_party/vulkan-loader/src/loader/loader.c || true
sed -i '' 's/SYSCONFDIR/"\/etc"/g' third_party/vulkan-loader/src/loader/loader.c || true
